...
class VG_Relation(Dataset):
    def __init__(self, transform = None):
        ...
        self.length = 5
        self.padding_num = 6
        self.tokenizer = BertTokenizer.from_pretrained('./checkpoints/bert-base-uncased')
        self.root_dir = "/mnt/sdb/wyn/Structure-CLIP-main/data/visual_genome_data/vg_image/"
...
class VG_Attribution(Dataset):
    def __init__(self, data_path=None, transform=None):
        ...
        if 'adjchange' in data_path:
            self.root_dir = '/mnt/sdb/wyn/Structure-CLIP-main/data/coco_data/'
        else:
            self.root_dir = "/mnt/sdb/wyn/Structure-CLIP-main/data/visual_genome_data/vg_image/"
    ...
    def __getitem__(self, index):
        ...
        # Get the bounding box that contains the relation
        if self.root_dir != '/mnt/sdb/wyn/Structure-CLIP-main/data/coco_data/':
